...
export const MenuList = props => {
  ...
  return (
    <div ref={menuRef}>
      ...
      <nav
        id='navbarCollapse'
        className={`absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg dark:bg-black lg:static lg:block lg:w-full lg:max-w-full lg:!bg-transparent lg:px-4 lg:!py-0 lg:!shadow-none dark:lg:!bg-transparent xl:px-6 ${
          showMenu ? 'bg-white py-5 shadow-lg dark:bg-black' : 'hidden'
        }`}>
